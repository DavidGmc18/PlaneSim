...
F16::F16(glm::vec3 pos, TextureCache& cache): model("assets/F-16/F-16.obj", cache, true) {
    ...
    parts.push_back(new Wing("Fuselage", &FUSELAGE, glm::vec3(0.0f, 0.0f, 0.4f), glm::vec3(0, 0, 1), glm::vec3(0, 1, 0), 15.0f, 4.5f));

    // sweep - 40°, +1° vertical
    parts.push_back(new Wing("Main wing L", &MAIN_WING, glm::vec3(-2.2f, 0.0f, 0.4f), glm::vec3(-0.643f, 0.013f, 0.766f), glm::vec3(0.0f, 0.999f, -0.017f), 4.959f, 2.8f));
